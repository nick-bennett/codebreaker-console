...
public class Main {
  ...
  public static final String PLAY_AGAIN_MESSAGE_KEY = "play_again_message";
  public static final String NEGATIVE_RESPONSE_KEY = "negative_response";
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.printf(bundle.getString(OUT_OF_RANGE_FORMAT_KEY),
          length, MINIMUM_CODE_LENGTH, MAXIMUM_CODE_LENGTH);
    } catch (IOException e) {
